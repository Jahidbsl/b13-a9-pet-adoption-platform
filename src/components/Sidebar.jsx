    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 h-20 bg-white/80 backdrop-blur-xl border-b border-purple-100 px-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-r from-[#8B5CF6] to-[#F472B6] flex items-center justify-center shadow-lg shadow-purple-200">
            <PawPrint className="text-white" size={22} />
          </div>

          <div>
            <h1 className="text-xl font-bold text-[#374151]">Pet Blossom</h1>
        ...
        >
          <Menu className="text-[#8B5CF6]" size={24} />
        </button>
      </div>
        ...
        <div className="h-24 px-6 flex items-center justify-between border-b border-purple-100">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500">Modern Dashboard</p>
            </div>
          </div>
          ...
          >
            <X size={22} className="text-[#8B5CF6]" />
          </button>
        </div>
            ...
            return (
              <NextLink
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "bg-gradient-to-r from-[#8B5CF6] to-[#F472B6] text-white shadow-xl shadow-purple-200"
